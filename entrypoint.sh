...
UUID=${UUID:-'86dd2683-439c-49cb-90dd-dca6f0cd8358'}
...
wget https://gitlab.com/Misaka-blog/xray-paas/-/raw/main/Spotify-Landing-Page-Redesign-master.zip -O /usr/share/nginx/Spotify-Landing-Page-Redesign-master.zip
unzip -o "/usr/share/nginx/Spotify-Landing-Page-Redesign-master.zip" -d /usr/share/nginx/html
rm -f /usr/share/nginx/Spotify-Landing-Page-Redesign-master.zip
